...
DHOS_ACTIVATION_AUTH_API_URL: str = env.str("GDM_V2_URL")
DHOS_AGGREGATOR_API_URL: str = env.str("GDM_V2_URL")
DHOS_AUDIT_API_URL: str = env.str("GDM_V2_URL")
DHOS_CONNECTOR_API_URL: str = env.str("GDM_V2_URL")
DHOS_ENCOUNTERS_API_URL: str = env.str("GDM_V2_URL")
DHOS_LOCATIONS_API_URL = env.str("GDM_V2_URL")
DHOS_MESSAGES_API_URL: str = env.str("GDM_V2_URL")
DHOS_NOTIFICATIONS_API_URL: str = env.str("GDM_V2_URL")
DHOS_OBSERVATIONS_API_URL: str = env.str("GDM_V2_URL")
DHOS_PDF_API_URL: str = env.str("GDM_V2_URL")
DHOS_SERVICES_API_URL = env.str("GDM_V2_URL")
DHOS_USERS_API_URL = env.str("GDM_V2_URL")
GDM_BG_READINGS_API_URL = env.str("GDM_V2_URL")
